...
import faviconImg from 'src/app/favicon.ico';
  ...
  return (
    <div className="grid w-full flex-grow items-center bg-white px-4 sm:justify-center">
      <SignIn.Root>
        ...
        >
          <header className="flex items-center mt-4 mb-16 0">
            <h1 className="text-4xl font-bold tracking-tight text-neutral-700">
              Sign In
            </h1>
            <Image src={faviconImg} alt="favicon" width={25} height={25} className="ml-2 opacity-80 object-cover shrink-0 w-[35px] h-[35px]" />
          </header>
